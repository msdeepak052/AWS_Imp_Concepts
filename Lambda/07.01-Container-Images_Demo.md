...
docker tag lambda-container-demo:latest \
  339712902352.dkr.ecr.ap-south-1.amazonaws.com/lambda-container-demo
  
docker push 339712902352.dkr.ecr.ap-south-1.amazonaws.com/lambda-container-demo/lambda-container-demo:latest
```
