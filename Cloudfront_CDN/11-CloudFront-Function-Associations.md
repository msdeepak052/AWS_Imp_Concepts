...
- Next: the [Function Associations hands-on demo](11.01-Function-Associations_Demo.md) — a hands-on demo that makes the edge-only token gate and request-mutation behavior above directly observable. Then the [Supported HTTP Versions and Default Root Object](12-CloudFront-Settings-Supported-HTTP-Versions-and-Default-Root-Object.md) note, covering distribution-wide (not cache-behavior-specific) settings.
