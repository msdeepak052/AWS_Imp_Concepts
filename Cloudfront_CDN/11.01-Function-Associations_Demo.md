...
2. **Name**: `EdgeGate-AddDefaults`.
3. **Continue** → this opens the **Build** tab's code editor.
4. Replace the default template with:
   ```javascript
...
2. **Name**: `StampEdgeHeader`.
3. **Continue** → **Build** tab:
   ```javascript
   function handler(event) {
