...
6. Replace the code in `lambda_function.py` with:
   ...
   ```
7. **Deploy**.
8. **Actions** (top-right dropdown) → **Publish new version** → **Version description**: `Stable release` → **Publish**. This freezes exactly this code as **Version 1** (the [Version Control In AWS Lambda](16-Lambda-Versions.md) note's Section 4).
