...
# Install stress (Amazon Linux 2023 supports dnf directly)
...
<a href="https://devopswithdeepak.co.in" target="_blank"
...
class="branding">Deepak - Devops Enthusiast</span></p>
</body>
</html>
EOF
...
nohup python3 /home/ec2-user/app.py > /home/ec2-user/flask_app.log 2>&1 &
