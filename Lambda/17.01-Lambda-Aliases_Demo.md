...
6. **Weight (%)**: `20` — Version 2 gets 20% of traffic, Version 1 automatically receives the remaining 80%.
...
3. **Aliases** tab → `prod` → open it → **Edit** (or the equivalent action on the alias's own page) → change **Additional version** from **2** to **3**, keep the weight at **40%** → **Save**.
4. Back on the `prod` alias's own **Test** tab → **Test** repeatedly — roughly 4 in 10 invocations now **fails** with the simulated exception, while the other 6 keep succeeding on Version 1.
...
### Version 3
<img width="2568" height="1351" alt="image" src="https://github.com/user-attachments/assets/faed6a8b-614f-4a2c-9f71-cdeda0ae7e16" />

<img width="2568" height="1351" alt="image" src="https://github.com/user-attachments/assets/0515a6ee-9a6a-4870-8908-6c7b621b2ae9" />

### Rollback to version 1

<img width="2568" height="1351" alt="image" src="https://github.com/user-attachments/assets/1c012e30-c90e-44b7-81ea-39ea2199fbb9" />

<img width="2568" height="1351" alt="image" src="https://github.com/user-attachments/assets/ab65218a-ea47-49ab-8b8a-699635113338" />
